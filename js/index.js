	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		function scrollPage(element, callback) {
			...
			element.find(".animation_class").addClass("active");
			element.find(".animation_class2").addClass("active");
			element.find(".animation_class3").addClass("active");
			element.find(".animation_class4").addClass("active");
